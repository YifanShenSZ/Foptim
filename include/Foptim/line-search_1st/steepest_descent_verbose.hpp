#ifndef Foptim_line_search_1st_steepest_descent_verbose_hpp
#define Foptim_line_search_1st_steepest_descent_verbose_hpp

#include <cstdint>

namespace { extern "C" {
    void steepest_descent_verbose_(
        // Required arguments
...
inline void steepest_descent_verbose(
    void (*f)(double &, const double *, const int32_t &),
    void (*f_fd)(double &, double *, const double *, const int32_t &),
    double * x, const int32_t & dim,
